                            ...
                            if (!$showRegister) :
                                ...
                                if ($options['login_layout'] == 'register-on-right-side') :
                                    ...
                                    <div class="argmc-login-tabs">
                                        <h3 class="tab-item current" data-target="argmc-login"><?php echo $options['login_heading']; ?></h3>
                                        <span class="tab-sep"><?php _e('/', 'argMC'); ?></span>
                                        <h3 class="tab-item" data-target="argmc-register"><?php echo $options['register_heading']; ?></h3>
                                    </div>
...
<div class="argmc-form-steps argmc-form-step-<?php echo $i; ?><?php echo $i == 1 ? ' first current' : ''; ?><?php echo !empty($step['class']) ? ' ' . $step['class'] : ''?>">
	<div class="row">
			<div class="column">
                        <div data-step="<?php echo $step['data']; ?>" >
                            <h3 class="step-name"><?php echo $step['text']; ?></h3>
                            <?php
                            if ($checkout->get_checkout_fields()) :
                                //do_action('woocommerce_checkout_before_customer_details');
...
<?php
	...
	<div class="argmc-nav">
		...
		<div class="argmc-nav-buttons">
        	<button id="argmc-tienda" class="button" type="button" onclick="window.location.replace('https://clute.com.pe/wordpress/tienda/');"><span><?php echo "Volver a la Tienda"; ?></span></button>
