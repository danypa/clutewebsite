<div class="wrap">
	...
	<div id="vp-wrap" class="vp-wrap">
		<?php $setlayout = ($set->get_layout() === 'fixed') ? 'fixed-layout' : 'fluid-layout';?>
		<div id="vp-option-panel"class="vp-option-panel <?php echo ''.$setlayout; ?>">
			...
			<div class="vp-right-panel">
				<form id="vp-option-form" class="vp-option-form vp-js-option-form" method="POST">
					<div id="vp-submit-top" class="vp-submit top">
						<div class="inner">
							<input class="vp-save vp-button button button-primary" type="submit" value="<?php esc_html_e('Save Changes', 'rehub-framework'); ?>" />
							<p class="vp-js-save-loader save-loader" style="display: none;"><img src="<?php VP_Util_Res::img_out('ajax-loader.gif', ''); ?>" /><?php esc_html_e('Saving Now', 'rehub-framework'); ?></p>
		...
		<div id="vp-copyright" class="vp-copyright">
			<p><?php printf('This option panel is built using <a href="http://vafpress.com/vafpress-framework">Vafpress Framework</a> powered by <a href="http://vafpress.com">Vafpress</a>', VP_VERSION); ?></p>
		</div>
	</div>
</div>