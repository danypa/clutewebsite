<div class="wooccm_order_attachments_wrapper">
  <h3 class="woocommerce-order-details__title"><?php echo ($title = get_option('wooccm_order_upload_files_title', false)) ? esc_html($title) : esc_html__('Uploaded files', 'woocommerce-checkout-manager'); ?></h3><!-- vanessa -->
