...
(function(d){MP.EntityType=can.Construct({initByEntity:function(a){return 1<a.length&&a.hasClass("motopress-row")?new this(IframeCE.Grid.ENTITIES.PAGE):a.hasClass("motopress-row")?new this(IframeCE.Grid.ENTITIES.ROW):a.hasClass("motopress-clmn")?new this(IframeCE.Grid.ENTITIES.COLUMN):new this(IframeCE.Grid.ENTITIES.WIDGET)}},{is_row:!1,is_clmn:!1,is_widget:!1,name:"",init:function(a){switch(a){case IframeCE.Grid.ENTITIES.WIDGET:this.is_widget=!0;break;case IframeCE.Grid.ENTITIES.COLUMN:this.is_clmn=
!0;break;case IframeCE.Grid.ENTITIES.ROW:this.is_row=!0;break;case IframeCE.Grid.ENTITIES.PAGE:this.is_row=!0}this.name=a}})})(jQuery);(function(d){function a(a){a=MP.Utils.strtr(motopressCE.settings.translations.CEPostLockedTakeOver,{"%userName%":a,"%sendback%":motopressCE.settings.sendbackText});confirm(a)?(wp.heartbeat.enqueue("mpceForcePostLock",!0),wp.heartbeat.connectNow()):MP.Editor.myThis.redirect(motopressCE.settings.sendback)}d(document).on({"heartbeat-send":function(a,c){c.mpcePostLock=
motopressCE.postID},"heartbeat-tick":function(b,c){c.lockingUser&&a(c.lockingUser)}});d(window).one("MPCE-EditorLoad",function(){motopressCE.settings.lockingUser&&a(motopressCE.settings.lockingUser)})})(jQuery);(function(d){"object"===("undefined"===typeof exports?"undefined":m(exports))&&"undefined"!==typeof module?module.exports=d():"function"===typeof define&&define.amd?define([],d):("undefined"!==typeof window?window:"undefined"!==typeof global?global:"undefined"!==typeof self?self:this).mpceGenerateUUID4=
d()})(function(){return function(){function d(a,b,c){function e(g,k){if(!b[g]){if(!a[g]){var n="function"==typeof require&&require;if(!k&&n)return n(g,!0);if(f)return f(g,!0);n=Error("Cannot find module '"+g+"'");throw n.code="MODULE_NOT_FOUND",n;}n=b[g]={exports:{}};a[g][0].call(n.exports,function(b){return e(a[g][1][b]||b)},n,n.exports,d,a,b,c)}return b[g].exports}for(var f="function"==typeof require&&require,g=0;g<c.length;g++)e(c[g]);return e}return d}()({1:[function(d,a,b){var c=[];for(d=0;256>
d;++d)c[d]=(d+256).toString(16).substr(1);a.exports=function(a,b){var d=b||0;return[c[a[d++]],c[a[d++]],c[a[d++]],c[a[d++]],"-",c[a[d++]],c[a[d++]],"-",c[a[d++]],c[a[d++]],"-",c[a[d++]],c[a[d++]],"-",c[a[d++]],c[a[d++]],c[a[d++]],c[a[d++]],c[a[d++]],c[a[d++]]].join("")}},{}],2:[function(d,a,b){var c="undefined"!=typeof crypto&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto)||"undefined"!=typeof msCrypto&&"function"==typeof window.msCrypto.getRandomValues&&msCrypto.getRandomValues.bind(msCrypto);
if(c){var e=new Uint8Array(16);a.exports=function(){c(e);return e}}else{var f=Array(16);a.exports=function(){for(var a=0,b;16>a;a++)0===(a&3)&&(b=4294967296*Math.random()),f[a]=b>>>((a&3)<<3)&255;return f}}},{}],3:[function(d,a,b){var c=d("./lib/rng"),e=d("./lib/bytesToUuid");a.exports=function(a,b,d){d=b&&d||0;"string"==typeof a&&(b="binary"===a?Array(16):null,a=null);a=a||{};a=a.random||(a.rng||c)();a[6]=a[6]&15|64;a[8]=a[8]&63|128;if(b)for(var k=0;16>k;++k)b[d+k]=a[k];return b||e(a)}},{"./lib/bytesToUuid":1,
"./lib/rng":2}]},{},[3])(3)});(function(d){CE.ShortcodeAtts=can.Construct.extend({getAttrsFromElement:function(a){var b={closeType:a.attr("data-motopress-close-type"),id:a.attr("data-motopress-shortcode"),group:a.attr("data-motopress-group"),resize:a.attr("data-motopress-resize")},c=a.attr("data-motopress-parameters");"undefined"!==typeof c&&(b.parameters=c);c=a.attr("data-motopress-styles");"undefined"!==typeof c&&(b.styles=c);a=a.attr("data-motopress-content");"undefined"!==typeof a&&(b.content=
a);return new this(b)},setAttsToEl:function(a,b){a.attr({"data-motopress-close-type":b.closeType,"data-motopress-shortcode":b.id,"data-motopress-group":b.group,"data-motopress-resize":b.resize});b.hasOwnProperty("parameters")&&a.attr("data-motopress-parameters",b.parameters);b.hasOwnProperty("styles")&&a.attr("data-motopress-styles",b.styles);b.hasOwnProperty("content")&&a.attr("data-motopress-content",b.content)}},{id:null,group:null,closeType:null,parameters:{},styles:{},resize:null,content:"",
init:function(a){this.id=a.id;var b=CE.WidgetsLibrary.myThis.getObjectById(this.id);b&&(this.group=b.groupId,this.closeType=b.closeType,this.resize=b.resize);a.hasOwnProperty("parameters")&&(this.parameters=a.parameters);a.hasOwnProperty("styles")&&(this.styles=a.styles);a.hasOwnProperty("content")&&(this.content=a.content)},isGrid:function(){return CE.Shortcode.isGrid(this.group)}})})(jQuery);(function(d){var a=!0,b=[];can.Control("CE.Iframe",{myThis:null,window:null,$window:null,$:null,contents:null,
runAndSetAsDependent:function(a){this.runDependentCallback(a);b.push(a)},runDependentCallback:function(a){a(this)},runDependentCallbacks:function(){if(!a)for(var c=0;c<b.length;c++)this.runDependentCallback(b[c])}},{minWidth:null,gridObj:null,grid:d("<div />",{id:"motopress-ce-grid","class":"mp-container"}),divDisablePlugin:d("<div />",{"class":"motopress-disable-plugin"}),isHeadwayTheme:null,$topBody:d("body"),body:null,sceneContent:null,sceneContainer:null,rowExample:null,wpAttachmentDetails:[],
$form:d("form#mpce-form"),init:function(b){CE.Iframe.myThis=this;CE.Iframe.window=this.element[0].contentWindow;a&&b.addClass("motopress-tmp-iframe-width");CE.Iframe.myThis.gridObj=parent.motopressCE.settings.library.grid;switch(this.detectSceneStatus()){case "pending":this.$topBody.one("MPCESceneDocError",b,CE.Iframe.myThis.proxy(function(a,b){this.showErrorMessage(b)}));this.$topBody.one("MPCESceneDocReady",b,CE.Iframe.myThis.proxy(function(){this.onReady()}));break;case "ready":this.onReady();
break;case "error":this.showErrorMessage(CE.Iframe.window.MPCESceneStatus.errorType)}},detectSceneStatus:function(){var a="pending";"undefined"!==typeof CE.Iframe.window.MPCESceneStatus&&CE.Iframe.window.MPCESceneStatus.hasOwnProperty("status")&&(a=CE.Iframe.window.MPCESceneStatus.status);return a},destroy:function(){a=!1;try{d(CE.Iframe.window).off("beforeunload.CE.Iframe"),d(parent.window).off("beforeunload.CE.Iframe"),this.deleteEventListeners(),IframeCE.Resizer.myThis._destroy(),IframeCE.InlineEditor._destroy(),
CE.Panels.SettingsDialog.myThis._destroy(),CE.Panels.Navbar.myThis._destroy()}catch(b){MP.Settings.debug&&console.error(b)}this._super()},showErrorMessage:function(a,b){var d={};switch(b){case "nonce":d={name:localStorage.getItem("editorNonceErrorName"),message:localStorage.getItem("editorNonceErrorMessage")};break;default:d={name:localStorage.getItem("editorAccessErrorName"),message:localStorage.getItem("editorAccessErrorMessage")}}MP.Error.log(d)},onReady:function(){CE.Iframe.contents=this.element.contents();
CE.Iframe.$=CE.Iframe.window.jQuery;CE.Iframe.$window=CE.Iframe.$(CE.Iframe.window);this.body=CE.Iframe.contents.find("body");this.$entryContent=this.body.find("#mpce-editable-content-marker").parent();CE.Iframe.$(this.$entryContent).html(decodeURIComponent(this.body.find("#mpce-post-content-template").html()+""));CE.Iframe.contents.find('link[href*="js_composer"]').remove();MP.Utils.addWpFrontEndEditorFix();CE.Iframe.myThis.wpAttachmentDetails=CE.Iframe.window.mpce_wp_attachment_details;this.sceneContent=
this.body.find(".motopress-content-wrapper");this.contentSectionExists=this.sceneContent.length;CE.Panels.Navbar.myThis.onIframeLoad(this.element);this.preventUnload();this.body.find("#wp-motopress-tmp-editor-wrap").hide();this.sceneContent.length||(this.body.append(this.divDisablePlugin),this.isHeadwayTheme?MP.Flash.setFlash(localStorage.getItem("CENeedHeadwayThemeGrid"),"error"):MP.Flash.setFlash(localStorage.getItem("CENeedContentOutput"),"error"));this.element.removeClass("motopress-tmp-iframe-width");
var a=this.sceneContent.width();this.body.addClass("motopress-body");this.sceneContent.find("script").remove();this.sceneContent.wrap('<div class="'+CE.Iframe.myThis.gridObj.span.fullclass+'" />').parent().wrap('<div class="'+CE.Iframe.myThis.gridObj.row["class"]+" "+CE.Iframe.myThis.gridObj.row.edgeclass+' motopress-row" />').parent().wrap('<div id="motopress-container" class="mp-container" />');this.sceneContainer=this.sceneContent.closest("#motopress-container");this.rowExample=this.sceneContainer.children(".motopress-row");
var b=this.sceneContainer.parents(),f=b.length-3;b.each(function(a){d(this).addClass("motopress-overflow-visible");return a<f});b=parseFloat(this.rowExample.css("margin-left"));this.rowExample.attr("data-margin-left",b);this.sceneContent.find("."+CE.Iframe.myThis.gridObj.span.minclass+".motopress-clmn").addClass("motopress-clmn-min");this.setSceneWidth(a);this.unwrapGrid();this.body.prepend(this.grid);this.$topBody.hide(0,this.proxy(function(){this.$topBody.show()}));CE.Iframe.window.mpceRunScene();
MP.Editor.triggerIfr("ParentEditorReady")},setSceneWidth:function(a){this.sceneContainer.css("max-width","");a="undefined"!==typeof a?a:this.sceneContent.width();var b=CE.Iframe.contents.width(),d=parseFloat(this.rowExample.css("margin-left")),g=parseFloat(this.rowExample.css("margin-right"));a=a-d-g;a>b&&(a=b+(d+g));this.sceneContainer.css("max-width",a);this.grid.css("max-width",a)},unwrapGrid:function(a){a&&a.length||(a=this.body);a.find('div[data-motopress-group="mp_grid"]:not(.ce_controls,.motopress-empty)').addBack('div[data-motopress-group="mp_grid"]:not(.ce_controls,.motopress-empty)').each(function(){var a=
d(this),b=a.attr("data-motopress-group"),c=a.attr("data-motopress-shortcode"),h=a.attr("data-motopress-parameters"),k=a.attr("data-motopress-styles"),a=a.children("div");a.attr("data-motopress-group",b);a.attr("data-motopress-shortcode",c);h.length&&a.attr("data-motopress-parameters",h);k.length&&a.attr("data-motopress-styles",k);a.unwrap()})},appendScript:function(a,b){a.appendChild(b)},prependScript:function(a,b){a.insertBefore(b,a.firstChild)},wpLinkCloseCallback:function(a){d(document).on("wplink-close.motopress",
