...
class MPCEUtils {
	 ...
	 * @param bool $withLeadingWhitespace Whether to output string of attributes with leading whitespace. Optional. Default: false
	...
	static function isAjax() {
		return mpce_is_wp_version('4.7.0', '>=') ? wp_doing_ajax() : defined('DOING_AJAX') && DOING_AJAX;
	}
