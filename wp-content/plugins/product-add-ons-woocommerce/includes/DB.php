...
class DB
{
    ...
    public static function check_new_tables() {
        ...
        if (!in_array('header_types', $tables)){
            $header_type_exist = self::is_column_exist($headers, 'header_type');
        ...
        if (!in_array('accordion', $tables)) {
            $accordion_exist = self::is_column_exist($types, 'accordion');
        ...
        if (!in_array('hiding', $tables)) {
            $column_exist = self::is_column_exist($types, 'hide_description');
