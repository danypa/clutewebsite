...
$cfg['blowfish_secret']					= 'qq:-=3eh+qQ&V`l#e_*A*Wr|*8LsfQD!' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_QJKd7ltrWGzIFM4gUL9XVPs/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
