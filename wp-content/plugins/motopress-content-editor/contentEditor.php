    ...
    <script type="text/javascript">
        jQuery(document).ready(function($) {
            if (!Browser.IE && !Browser.Opera) {
                ...
                // CAMBIO 19-12-2019 // importarERP importarerp-ce-btn
                /*
                var importarERP = $('<input />', {
                    type: 'button',
                    id: 'importarerp-ce-btn',
                    'class': 'wp-core-ui button-secondary',
                    value: 'Importar desde ERP',
                    'data-post-id' : '<?php echo $post->ID?>',
                    disabled: 'enabled'
                }).insertAfter($('div#titlediv'));                  
                */
                // FIN CAMBIO 19-12-2019
...
/*
                        function importarERPInit() {
                            importarERP.removeAttr('disabled');
                            importarERP.click();
                        }
*/
