	...
	if ( true == $responsive_check ) {
		...
		<div class="email-spacing-wrap" style="margin-bottom: 40px;">
			<table class="td" cellspacing="0" cellpadding="6" style="width: 100%;" border="1">
				<thead>
					<tr>
						<th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e( 'Producto', 'kadence-woocommerce-email-designer' ); ?></th>
						<th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e( 'Precio', 'kadence-woocommerce-email-designer' ); ?></th>
					</tr>
				</thead>
				<tbody>
		...
		<div class="email-spacing-wrap" style="margin-bottom: 40px;">
			<table class="td" cellspacing="0" cellpadding="6" style="width: 100%;" border="1">
				<thead>
					<tr>
						<th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;">HOLA MUNDOs<?php esc_html_e( 'Producto', 'kadence-woocommerce-email-designer' ); ?></th>
						<th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e( 'Cantidad', 'kadence-woocommerce-email-designer' ); ?></th>
						<th class="td" scope="col" style="text-align:<?php echo esc_attr( $text_align ); ?>;"><?php esc_html_e( 'Precio', 'kadence-woocommerce-email-designer' ); ?></th>
					</tr>
				</thead>
				<tbody>
