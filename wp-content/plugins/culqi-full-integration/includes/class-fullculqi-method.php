							...
							[
								...
								'multi_duration' => [
									...
									'options'		=> [
														...
														'48'	=> __('2 Días','letsgo'),
														'96'	=> __('4 Días','letsgo'),
														'168'	=> __('7 Días','letsgo'),
														'360'	=> __('15 Días','letsgo'),
													],
									'default'		=> '24',
									'desc_tip'		=> true,
								],
								...
								'msg_fail' => [
									...
									'type'			=> 'textarea',
									'desc_tip'		=> false,
									'default'		=> __('Ocurrió un error al realizar el pago. Verifique que los datos de su tarjeta sean correctos e intente nuevamente.','letsgo'),
								],
								'time_modal' => [
