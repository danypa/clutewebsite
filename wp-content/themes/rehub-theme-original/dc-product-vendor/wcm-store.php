							...
							<?php if ( $verified_vendor ) : ?>
								<?php 				
									...
									if(!$vendor_verified_label){
										$vendor_verified_label = '<div class="wcv-verified-vendor"><i class="fas fa-shield-check" aria-hidden="true"></i> '.__( 'Verified', 'rehub-theme' ).'</div>';
									}
								?>									
							...
							<div>
								<?php if($vendor_phone) : ?>
									<a href="tel:<?php echo esc_html($vendor_phone); ?>" class="mr5">
										<i class="fas fa-mobile-android-alt"></i> <?php echo esc_html($vendor_phone); ?>
									</a>
								<?php endif; ?>
								<?php if($vendor_email) : ?>								
									<a href="mailto:<?php echo antispambot( $vendor_email ); ?>" class="mr5">
										<i class="far fa-envelope"></i> <?php echo ''.$vendor_email; ?>
									</a>
								<?php endif; ?>								
							</div>
						</div>
			...
			<div class="rh-cartbox widget">
				<div>
					...
					<div class="profile-stats">
						<div><i class="far fa-user-circle"></i> <?php esc_html_e( 'Registration', 'rehub-theme' );  echo ': ' . date_i18n( get_option( "date_format" ), strtotime( $vendor->user_data->user_registered )); ?></div>
					...
					<div class="profile-description wcmp-profile-contacts">
						<span class="fontbold"><?php esc_html_e( 'Contact', 'rehub-theme' ); ?></span>
