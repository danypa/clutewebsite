...
class WPSM_Canvas_A_Widget extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control( 'rh_canvas_type', [
            ...
            'default' => 'particles',
            'options'     => [
                'particles'   =>  esc_html__('Particles', 'rehub-theme'),
        ...
        $this->add_control(
            ...
            array(
                ...
                'description' => esc_html__( 'Video will be replaced by Fallback image after if window width less than this breakpoint', 'rehub-theme' ),
    ...
    protected function render() {
        ...
        if ( !empty($settings['rh_particle_json'])) {
        ...
        } else if(!empty($settings['rh_canvas_type']) && $settings['rh_canvas_type'] == 'video') {
            ...
            if ( ! empty( $settings['rh_vid_poster'] )) {
                $this->add_render_attribute( 'rh_vid_data', 'data-poster', $settings['rh_vid_poster']['url'] );
            }
            ...
            <div data-id="<?php echo esc_attr($widgetId); ?>" class="rh-svgblob-wrapper" <?php echo ''.$this->get_render_attribute_string( '_svgrapper' )?>>
                <svg class="rh-svg-blob" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 600" preserveAspectRatio="xMidYMid meet" xml:space="preserve">
                    ...
                    <?php if($settings['svg_image']['id'] != '' || $settings['gradientcolor1'] != ''):?>
                        <style>
