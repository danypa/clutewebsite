 ...
 * @extends WC_Widget
 */
class WP_Categories_Class_2 extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_name        = __( 'Categoria de Productos - DSS', 'woocommerce' );
		$this->settings           = array(
			'title'              => array(
				'type'  => 'text',
	...
	public function widget( $args, $instance ) {
		...
		if ( $dropdown ) {
			...
			custom_list_categories( apply_filters( 'woocommerce_product_categories_widget_args', $list_args ) );
