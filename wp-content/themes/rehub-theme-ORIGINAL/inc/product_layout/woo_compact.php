                ...
                <div class="content-woo-area rh-container flowhidden rh-stickysidebar-wrapper">                                
                    <div class="rh-300-content-area tabletblockdisplay floatleft pt15 rh-sticky-container">
                        ...
                        <div class="position-relative mt10" id="rh_woo_layout_inimage">
                            ...
                            <?php else:?>
                                <style scoped>#rh_woo_layout_inimage{background: linear-gradient(120deg, rgb(39, 43, 47) 15%, rgb(5, 123, 91) 55%, rgb(5, 123, 91) 100%);}</style>
                            <?php endif;?> 
                            <div class="rh-flex-eq-height rh-flex-nowrap mobileblockdisplay pt25 pr25 pl25 pb5 whitecolor position-relative zind2">                             
                                <div class="woo-image-part mr15 mb15 rtlml15">
                                ...
                                <div class="woo-title-area mb10 flowhidden rh-flex-grow1">
                                    ...
                                    <div class="meta post-meta">
                                        <?php rh_post_header_meta('full', false, true, false, true);?> <span class="more-from-store-a"><?php WPSM_Postfilters::re_show_brand_tax('list');?></span>   
                                    </div>                                 
                        ...
                        if ( ! empty( $tabs ) ) : ?>
                            <div id="contents-section-woo-area">
                                <ul class="scroll-on-mobile mb20 rehub-main-font clearfix contents-woo-area lightgreybg rh-big-tabs-ul">
