                    ...
                    <?php if (defined('\ContentEgg\PLUGIN_PATH')):?>
                        ...
                        <div class="floatright pl20">
                            ...
                            <?php if($amazonupdate && $product_update):?>
                                <div class="font60 lineheight20"><?php esc_html_e('Last price update was:', 'rehub-theme');?> <?php echo ''.$product_update;?> <span class="csspopuptrigger" data-popup="ceblocks-amazon-disclaimer"><i class="far fa-question-circle greycolor font90"></i></span></div>
                            ...
                            <div class="ce_woo_block_top_holder">
                                ...
                                <div class="wpsm-two-third rh-line-left pl20 rtlpr20 pt15 tabletblockdisplay wpsm-column-last mb30 disablemobileborder disablemobilepadding">
                                        ...
                                        <span class="floatleft disablefloatmobile meta post-meta mt0 mb0">
                                            ...
                                            if ( ! empty( $categories ) ) {
                                                foreach( $categories as $category ) {
                                                    $output .= '<a class="mr5 ml5 rh-cat-'.$category->term_id.'" href="' . esc_url( get_term_link( $category->term_id, 'product_cat' ) ) . '" title="' . esc_attr( sprintf( esc_html__( 'View all posts in %s', 'rehub-theme' ), $category->name ) ) . '">' . esc_html( $category->name ) . '</a>' . $separator;
                                                }
                                    ...
                                    <div class="rh_post_layout_rev_price_holder">
                                        ...
                                        <?php echo do_shortcode('[content-egg-block template=custom/all_simple_list_group]');?>
                                        <span class="rehub-main-font font80 mb20 rehub_scroll blockstyle rehub-main-color text-right-align cursorpointer" data-scrollto="#section-woo-ce-pricelist"><?php esc_html_e('Check all prices', 'rehub-theme');?></span> 
                                    ...
                                    <div class="woo-single-meta font80">
                                        ...
                                        <?php if (!empty($term_ids) && ! is_wp_error($term_ids)) :?>
                                            <div class="woostorewrap mb10">         
                                                <div class="store_tax">       
                                                    <?php WPSM_Woohelper::re_show_brand_tax('logo'); //show brand taxonomy?>
                                                </div>  
                                            </div>
                                        <?php endif;?>                              
