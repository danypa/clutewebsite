	...
	<ul>
		<?php foreach ( wc_get_account_menu_items() as $endpoint => $label ) : ?>
			<li class="<?php echo wc_get_account_menu_item_classes( $endpoint ); ?>">
				...
				<a class="navigationc" href="<?php echo esc_url( wc_get_account_endpoint_url( $endpoint ) ); ?>" ><img width="30px" src="<?php echo esc_url( get_site_url()."/wp-content/uploads/".($label=="Inicio"?"inicio_icon.png":($label=="Cambiar Contraseña"?"candado_icon.png":($label=="Pedidos"?"pedidos_icon.png":"ubicacion_icon.png"))) ); ?>" style="padding:0px 0px 0px 5px; margin-right: 5px;"><?php echo esc_html( $label ); ?></a><!-- vanessa -->
			</li>
		<?php endforeach; ?>
	</ul>
</nav>
