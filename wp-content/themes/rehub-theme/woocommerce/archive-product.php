...
<!-- <img src="https://www.clute.com.pe/wp-content/uploads/2020/05/page-header-default-1.jpg" alt="barra-superior"><br> -->

<?php $left_sidebar = (rehub_option('rehub_sidebar_left_shop')) ? true : false;?>
<?php $mobile_sidebar = (rehub_option('sidebar_mobile_shop')) ? true : false;?>
...
<div class="rh-container rh_woo_main_archive"> 
    <div class="rh-content-wrap clearfix <?php if($left_sidebar):?>left-sidebar-archive<?php endif;?>"<?php if($mobile_sidebar){echo ' id="rh_woo_mbl_sidebar"';}?>>
        ...
        <!-- Main Side -->
        <div class="main-side woocommerce page clearfix<?php if(true/*rehub_option('woo_columns') =='4_col' >>fullwidth*/) {echo ' full_width';}?>" id="content">
            <article class="post" id="page-<?php the_ID(); ?>">
                <?php do_action( 'woocommerce_before_main_content' );?>
                <?php woocommerce_breadcrumb();?>   
                <?php if(is_product_taxonomy() && !$catimage) {echo'<h1>'.$page_title.'</h1>';}  ?>       
        ...
        <?php if(!$left_sidebar && false/*rehub_option('woo_columns') !='4_col'  >>fullwidth*/):?>
            <!-- Sidebar -->
            <?php get_sidebar('shop'); ?>
            <!-- /Sidebar -->
        <?php endif;?> 
