...
<div class="full_width woo_full_width_advanced" id="content">
  ...
  <?php foreach ( $tabs as $key => $tab ) : ?>
                                ...
                                <?php if($key=='wcpoa_product_tab') call_user_func( $tab['callback'], $key, $tab ); ?>
...
<?php                               //  
	do_action( 'woocommerce_single_product_summary_quote' );
 ?>
                                </div>                            
 ...
 <div class="clearfix"></div>                             
                                <?php /*do_action('rhwoo_template_single_add_to_cart');*/ woocommerce_template_single_add_to_cart(); ?>
