...
<?php $addstyles = '.buddypress-page.main-side.full_width{padding: 30px 35px 20px 35px; background: #fff;box-shadow: 0 0 50px #e3e3e3;}.rh-container{max-width:'.$memberpx.'}';
					 	...
					 	<div class="rehub-login-popup re-user-popup-wrap">
							...
							<form id="rehub_login_form_modal" action="<?php echo home_url( '/' ); ?>" method="post">
								...
								<div class="re-form-group mb20">
									<label><?php 'hola'.esc_html_e('Username', 'rehub-theme') ?></label>
